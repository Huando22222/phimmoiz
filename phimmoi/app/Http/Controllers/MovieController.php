...
class MovieController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        History::whereIn('id_movie',[$movie->id])->delete();
        Favorite::whereIn('id_movie',[$movie->id])->delete();
        Comment::whereIn('id_movie',[$movie->id])->delete();
        Report::whereIn('id_movie',[$movie->id])->delete();
        Star::whereIn('id_movie',[$movie->id])->delete();
        $movie->delete();
